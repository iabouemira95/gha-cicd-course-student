...
| `EX-11: PR-Based CI/CD with Branch Protection` | deployment readiness as a team rule | it reinforces that delivery should happen only after a trusted verification path |
