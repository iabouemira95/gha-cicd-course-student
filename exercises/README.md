...
These exercises come after the matching lab.
...
1. [EX-01: Hello Trigger and PR Merge](EX-01-hello-trigger-and-pr-merge.md)

After [LAB-02: Real CI Workflow](../labs/LAB-02-real-ci-workflow.md):
...
`EX-06`, `EX-07`, and `EX-08` all extend the build workflow from `LAB-03`.

After [LAB-03: Build Artifact Workflow](../labs/LAB-03-build-artifact-workflow.md):

1. [EX-06: Build Artifact with Buildx](EX-06-build-artifact-with-buildx.md)
2. [EX-07: Build Artifact Scan with Trivy](EX-07-build-artifact-scan-with-trivy.md)
3. [EX-08: CI Then Build Artifact With `needs`](EX-08-ci-then-build-artifact-with-needs.md)

After [LAB-04: Deploy Workflow](../labs/LAB-04-deploy-workflow.md):

1. [EX-09: Deploy and Inspect the Deployment](EX-09-deploy-inspect-the-deployment.md)

After [LAB-05: Full CI/CD Flow](../labs/LAB-05-full-cicd-flow.md):

1. [EX-10: Full Flow Failure and Recovery](EX-10-full-flow-failure-and-recovery.md)
2. [EX-11: PR-Based CI/CD with Branch Protection](EX-11-pr-based-ci-cd-with-branch-protection.md)

After [LAB-07: Final Assessment Setup and Validation Prep](../labs/LAB-07-docker-hub-vm-deploy.md):

1. [EX-12: Final Deployment Assessment](EX-12-final-deployment-assessment.md)
